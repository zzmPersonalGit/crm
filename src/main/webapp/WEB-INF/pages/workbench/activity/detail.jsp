        ...
        $(function () {
            ...
            $("#remarkListDivFather").on("click", " a[name='deleteA']", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            window.location.href = 'workbench/activity/toDetail?id=' + activityId
                        } else {
                            alert("删除失败...")
                        }
                    }
...
<div id="remarkListDivFather" style="position: relative; top: 30px; left: 40px;">
    ...
    <div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
        <form role="form" style="position: relative;top: 10px; left: 10px;">
            <textarea id="activityRemarkDetail" class="form-control" style="width: 850px; resize : none;" rows="2"
