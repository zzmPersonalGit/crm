...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            // TODO 查询市场活动的关联信息,展现关联的市场活动
            queryActivityRelation();

            // TODO 点击关联市场活动按钮,展现客户所未关联的市场活动
            ...
            $("#relationActivitiesTbody").on("click", "a", function () {
                if (!window.confirm("是否解除客户和对应的市场活动")) {
                    return;
                }
            ...
            $("#saveClueRemarkBtn").click(function () {
                ...
                $.ajax({
                    url: 'workbench/clue/createRemarkDetail',
                    type: 'POST',
                    data: {
                        "clueId": clueId,
                    ...
                    success: function (data) {
                        if (data.code = "1") {
                            ...
                            htmlStr += "	<img title=\"${clue.owner}\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">";
                            htmlStr += "	<div style=\"position: relative; top: -40px; left: 40px;\" >";
                            htmlStr += "	<h5>" + data.object.noteContent + "</h5>";
                            htmlStr += "		<font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${clue.fullname}-${clue.company}</b> " +
            ...
            $("#remarkListDivFather").on("click", " a[name='deleteA']", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            window.location.href = 'workbench/clue/toDetail?id=' + clueId
                        } else {
                            alert("删除失败...")
                        }
                    }
            ...
            $("#updateRemarkBtn").click(function () {
                ...
                $.ajax({
                    url: 'workbench/clue/editClueRemarkById',
                    type: 'POST',
                    data: {
                        "clueId": clueId,
                        "id": remarkId,
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default"
                onclick="window.location.href='workbench/clue/toConvert?id=${clue.id}';"><span
                class="glyphicon glyphicon-retweet"></span> 转换为真实客户
        </button>
    </div>
</div>
...
<!-- TODO 备注信息 -->
<div id="remarkListDivFather" style="position: relative; top: 40px; left: 40px;">
    <div class="page-header">
        <h4>备注</h4>
    </div>
